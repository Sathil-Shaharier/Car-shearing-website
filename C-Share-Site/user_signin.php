...
<body>
    <div class="contain">
        <div class="forms-container">
            <div class="signin">
                <form action="http://localhost/C-Share-Site/backend_file/user_login_connection.php" method="post" class="sign-in-form">
                    <h1 class="top-title">Ride With Best Offered Price?</h1>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <a class="btn-link" href="http://localhost/C-Share-Site/user_signup.php"><button class="btn1 transparent" id="sign-up-btn">
                            Sign up
                        </button></a>
