...
<body onload="checkCookie()">
  <div class="contain">
    <div class="forms-container">
      <div class="signin">
        <form action="http://localhost/C-Share-Site/backend_file/user_info_connection.php" method="post" class="sign-in-form">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          ...
          <a class="btn-link" href="http://localhost/C-Share-Site/user_signin.php"><button class="btn1 transparent" id="sign-up-btn">
              Sign In
            </button></a>
        </div>
